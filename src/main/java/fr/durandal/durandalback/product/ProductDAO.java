...
public class ProductDAO {
	...
	public static void initProducts() {
		...
		Product p1 = new Product("1000 bornes",s1,19.90,35,"Cartes et petits jeux", "/image/1000-bornes.jpg");
		Product p2 = new Product("Copyright",s2,10.90,22,"Cartes et petits jeux", "/image/copyright.jpg");
		Product p3 = new Product("Illico",s3,11.50,36,"Cartes et petits jeux", "/image/illico.jpg");
		Product p4 = new Product("Cat cube",s4,10.90,60,"Casse tête", "/image/cat-cube.jpg");
		Product p5 = new Product("Molkky original",s5,29.90,16,"Casse tête", "/image/molkky-original.jpg");
		Product p6 = new Product("Rubik's cube",s6,16.90,41,"Casse tête", "/image/rubik-s-cube.jpg");
		Product p7 = new Product("Fallout",s7,53.90,29,"Jeux de plateau expert", "/image/fallout.jpg");
		Product p8 = new Product("Merlin",s8,49.90,25,"Jeux de plateau expert", "/image/merlin.jpg");
		Product p9 = new Product("Notre dame",s9,31.50,18,"Jeux de plateau expert", "/image/notre-dame.jpg");
		Product p10 = new Product("Cluedo",s10,29.90,3,"Jeux de plateau famille", "/image/cluedo.jpg");
		Product p11 = new Product("Monopoly",s11,13.90,19,"Jeux de plateau famille", "/image/monopoly.jpg");
		Product p12 = new Product("Risk",s12,37.90,16,"Jeux de plateau famille", "/image/.jpg");
		Product p13 = new Product("Jeu d'échecs et de dames",s13,14.50,30,"Jeux de reflexion", "/image/1000-bornes.jpg");
		Product p14 = new Product("Rush Hour",s14,21.90,12,"Jeux de reflexion", "/image/1000-bornes.jpg");
		Product p15 = new Product("Tetris Link",s15,21.90,15,"Jeux de reflexion", "/image/1000-bornes.jpg");
		Product p16 = new Product("Escape Game Junior",s16,7.90,12,"Jeux de rôle", "/image/1000-bornes.jpg");
		Product p17 = new Product("Donjons et dragons guide du maître",s17,49.90,7,"Jeux de rôle", "/image/1000-bornes.jpg");
		Product p18 = new Product("L'Anneau Unique",s18,49.95,25,"Jeux de rôle", "/image/1000-bornes.jpg");
		Product p19 = new Product("1944 Race to the Rhine",s19,48.90,8,"Jeux de wargame", "/image/1944-race-to-the-rhine.jpg");
		Product p20 = new Product("Britannia",s20,37.90,22,"Jeux de wargame", "/image/1000-bornes.jpg");
		Product p21 = new Product("Les Vikings",s21,53.90,15,"Jeux de wargame", "/image/1000-bornes.jpg");
		Product p22 = new Product("La révolution américiane",s22,42.90,23,"Jeux d'histoire", "/image/1775-la-revolution-americaine.jpg");
		Product p23 = new Product("Le chemin de fer clandestin",s23,52.90,18,"Jeux d'histoire", "/image/1000-bornes.jpg");
		Product p24 = new Product("ResPublica Romana",s24,49.90,16,"Jeux d'histoire", "/image/1000-bornes.jpg");
		Product p25 = new Product("Défis nature chrono",s25,18.90,25,"Jeux éducatif", "/image/1000-bornes.jpg");
		Product p26 = new Product("Drapeaux du monde",s26,13.90,7,"Jeux éducatif", "/image/1000-bornes.jpg");
		Product p27 = new Product("Maxitour paris",s27,29.90,10,"Jeux éducatif", "/image/1000-bornes.jpg");
		Product p28 = new Product("Les Petites Souris",s28,19.90,5,"Jeux jeunes Enfants", "/image/1000-bornes.jpg");
		Product p29 = new Product("Little Balancing",s29,8.90,15,"Jeux jeunes Enfants", "/image/1000-bornes.jpg");
		Product p30 = new Product("Pippo",s30,8.90,15,"Jeux jeunes Enfants", "/image/1000-bornes.jpg");
